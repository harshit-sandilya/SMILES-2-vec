...
MODEL_PATH = RESULTS_DIR / "models" / "final_model_GCN.ckpt"
OUT_PATH = RESULTS_DIR / "embeddings_GCN.pkl"
...
def main():
    ...
    # -------- Load model --------
    model = GraphMoleculeLightningGCN.load_from_checkpoint(MODEL_PATH)
